...
- **`TodoMap`** — Google Map plotting every todo that has coordinates; pins colored by priority (gray when completed), click selects the todo, auto-fits bounds. Renders nothing without `NEXT_PUBLIC_GOOGLE_MAPS_API_KEY`.
